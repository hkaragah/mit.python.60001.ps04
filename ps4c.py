...
class SubMessage(object):
    ...
    def build_transpose_dict(self, vowels_permutation):
        ...
        for index in range(len(vowels_permutation)):
            transpose_dict[VOWELS_UPPER[index]] =  upper_vowels_permutation[index]
            transpose_dict[VOWELS_LOWER[index]] = lower_vowels_permutation[index]
    ...
    def apply_transpose(self, transpose_dict):
        ...
        for index in range(len(self.message_text)):
            try:
                encrypted_message += transpose_dict[self.message_text[index]]
            except KeyError:
                encrypted_message += self.message_text[index]
...
class EncryptedSubMessage(SubMessage):
    ...
    def decrypt_message(self):
        ...
        max_valid_words = 0
        best_decrytion = self.message_text

        permutation_list = get_permutations(VOWELS_LOWER)
        for vowels_permutation in permutation_list:
...
if __name__ == '__main__':
    ...
    message = SubMessage('Don’t you want to know what your friends are saying?')
    permutation = 'uieao'
    enc_dict = message.build_transpose_dict(permutation)
    print("Original message:", message.get_message_text(), "Permutation:", permutation)
    print("Actual encryption:", message.apply_transpose(enc_dict))
    ...
    message = SubMessage('You could just replace each letter with the correct, decoded letter.')
    permutation = 'iaeuo'
    enc_dict = message.build_transpose_dict(permutation)
    print("Original message:", message.get_message_text(), "Permutation:", permutation)
    print("Actual encryption:", message.apply_transpose(enc_dict))
